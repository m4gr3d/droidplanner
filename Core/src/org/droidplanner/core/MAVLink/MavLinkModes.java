...
public class MavLinkModes {
	public static void setGuidedMode(AbstractDrone drone, double latitude, double longitude,
                                     double d) {
	...
	public static void changeFlightMode(AbstractDrone drone, ApmModes mode) {
