package org.droidplanner.android.lib.maps;
 ...
 */
public interface BaseDPMap extends DroneInterfaces.OnDroneListener {

	public static final String PACKAGE_NAME = BaseDPMap.class.getPackage().getName();
    ...
    /**
     * Components using a BaseDPMap instance must implement this interface.
     */
	...
	interface OnMarkerClickListener {
		 ...
		 */
		boolean onMarkerClick(BaseMarkerInfo markerInfo);
	}
	...
	interface OnMarkerDragListener {
		 ...
		 * location can be accessed via {@link BaseMarkerInfo#getPosition()}
		 * 
		 * @param markerInfo
		 *            info about the marker that was dragged.
		 */
		void onMarkerDrag(BaseMarkerInfo markerInfo);
		 ...
		 *            info about the marker that was dragged.
		 */
		void onMarkerDragEnd(BaseMarkerInfo markerInfo);

		/**
		 * Called when a marker starts being dragged. The marker's location can
		 * be accessed via {@link BaseMarkerInfo#getPosition()}; this position may
		 ...
		 *            info about the marker that was dragged.
		 */
		void onMarkerDragStart(BaseMarkerInfo markerInfo);
